...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'tintumown7@gmail.com', // Your Mega A/c Email Here
            password: 'tintu1234' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'TINTU-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of TINTU-MD.
...
🚀 _Thanks for choosing TINTU-MD — Let the automation begin!_ ✨`;
